...
list_of_edge_square_ratio = [i*0.02 for i in range(51)]

for edge_square_ratio in list_of_edge_square_ratio:
    ...
    for i in range(100):
        ...
        G = nq.newman_square_configuration(deg_seq, edge_square_ratio)
...
pickle.dump(data_compilation, open('./properties_square.txt', 'wb'))
